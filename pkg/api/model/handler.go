	...
	mh.Routes = []api.Route{
		{
			...
			Pattern:     "/",
			HandlerFunc: mh.create,
		},
		{
			Name:        "corsPreflight",
			Method:      http.MethodOptions,
			Pattern:     "/",
			HandlerFunc: mh.corsPreflightHandler,
		},
		{
			Name:        "updateModel",
			Method:      http.MethodPut,
			Pattern:     "/{id}",
			HandlerFunc: mh.update,
		},
		{
			Name:        "deleteModel",
			Method:      http.MethodDelete,
			Pattern:     "/{id}",
			HandlerFunc: mh.delete,
		},
		{
			Name:        "listAllModels",
			Method:      http.MethodGet,
			Pattern:     "/",
			HandlerFunc: mh.listAll,
		},
		{
			Name:        "listModelsByTag",
			Method:      http.MethodGet,
			Pattern:     "/{tag}",
			HandlerFunc: mh.listByTag,
		},
		{
			Name:        "inspectModel",
			Method:      http.MethodGet,
			Pattern:     "/{id}",
			HandlerFunc: mh.inspect,
		},
		{
			Name:        "uploadFile",
			Method:      http.MethodPost,
			Pattern:     "/file",
			HandlerFunc: mh.uploadHandler,
		},
		{
			Name:        "fetchImage",
			Method:      http.MethodGet,
			Pattern:     "/image",
			HandlerFunc: mh.fetchImage,
		},
		{
			Name:        "addNote",
			Method:      http.MethodPost,
			Pattern:     "/note",
			HandlerFunc: mh.addNote,
		},
		{
			Name:        "parseGCode",
			Method:      http.MethodGet,
			Pattern:     "/gcode",
			HandlerFunc: mh.parseGCode,
		},
		{
			Name:        "fetchSTL",
			Method:      http.MethodGet,
			Pattern:     "/stl",
			HandlerFunc: mh.fetchSTL,
		},
		{
			Name:        "fetchSTLThumbnail",
			Method:      http.MethodGet,
			Pattern:     "/stl/image",
			HandlerFunc: mh.fetchSTLThumbnail,
		},
		{
			Name:        "exportModel",
			Method:      http.MethodGet,
			Pattern:     "/export",
			HandlerFunc: mh.exportModelHandler,
		},
	}
